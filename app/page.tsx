...
const basePath = '/test-1774326308775';
...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'test', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+1', icon: 'domain' }, { n: 'test', d: 'test', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+2', icon: 'architecture' }, { n: 'test', d: 'test', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+3', icon: 'chair' }, { n: 'test', d: 'test', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+4', icon: 'eco' }, { n: 'test', d: 'test', i: 'https://placehold.co/600x400/e2e8f0/64748b?text=Product+5', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">ets</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">test</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Integrity</h4>
                  <p className="text-sm text-on-surface-variant">etes</p>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">info@stinablis.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">+60 11-1795-7335</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-center gap-6">
            <a href="https://www.nike.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">Facebook</a>
            <a href="https://www.nike.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">Instagram</a>
